...
class TascTrialBalanceCostCenterReporttWizard(models.TransientModel):
    """ Class for TASC Trial Balance - Cost Center Report xlsx """
    _name = 'tasc.trial.balance.cc.report.wizard'
    _description = 'TASC Trial Balance - Cost Center Report'
    ...
    def print_report_xlsx(self):
        ...
        self.excel_sheet_name = 'TASC Trial Balance - Cost Center Report'
        workbook.close()
        output.seek(0)
        ...
        return {
            ...
            'name': 'TASC Trial Balance - Cost Center Report',
    ...
    def get_report_data(self):
        """Method to compute TASC Trial Balance - Cost Center Report."""
        ...
        qry = f'''SELECT
                   ...
                   GROUP BY account_account.id,cc.id
        ...
        for entry in res:
            grouped_data[(
                entry['account_id'], entry['account_name'], entry['cc_name'], entry['code'],
    ...
    def add_xlsx_sheet(self, data, workbook, STYLE_LINE_Data,
                       header_format, STYLE_LINE_HEADER, date_format):
        """ Method to add datas to the TASC Trial Balance - Cost Center Report"""
        self.ensure_one()
        worksheet = workbook.add_worksheet(
            _('TASC Trial Balance - Cost Center Report'))
        ...
        worksheet.merge_range(row, row, col, col + 6,
                              _('TASC Trial Balance With Cost Center Report'),
                              STYLE_LINE_HEADER)
        row += 1
        col = 0
