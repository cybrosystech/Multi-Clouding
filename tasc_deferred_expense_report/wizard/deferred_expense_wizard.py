...
class DeferredExpenseWizard(models.Model):
    ...
    def add_xlsx_sheet(self, report_data, workbook, STYLE_LINE_Data,
        ...
        col += 1
        worksheet_summary.write(row, col, _('Posted Amount'), header_format)
        col += 1
        ...
        col += 1
        worksheet.write(row, col, _('Posted Amount' + "(" + str(
            self.company_id.currency_id.symbol) + ")"), header_format)
        col += 1
        ...
        col += 1
        worksheet.write(row, col, _('Posted Count'), header_format)
        col += 1
