...
export class BudgetAnalysisReportLine extends AccountReportLine {
    static template = "tasc_budget_analysis_report.BudgetAnalysisReportLine";
...
AccountReport.registerCustomComponent(BudgetAnalysisReportLine);
