        ...
        for line in report_data:
            ...
            if line.child_ids:
                ...
                for child in line.child_ids:
                    ...
                    ext_col_start = head_col + (5 * (ext - 1))  # Dynamically shift right for each extension
                    ext_col_end = ext_col_start + 4
        ...
        if contract.child_ids:
            for child in contract.child_ids:
                ...
                if extension_text == 'Original Leasee':
                    worksheet.merge_range(row2, 0, row2, head_col + 4,
                                          _(extension_text),
