...
class AccountMoveVendor(models.Model):
    ...
    #     for move in self:
    #         if not highest_name and move == self[
    #             0] and not move.posted_before and move.date:
    ...
    #             group['format'], group[
    #                 'format_values'] = move._get_sequence_format_param(
    #                 move.name)
    ...
    #                     or dict(final_batches[-1]['format_values'],
    #                             seq=0) != dict(date_group['format_values'],
    #                                            seq=0)
    #             ):
    ...
    #         if final_batches:
    #             final_batches[0]['format_values']['prefix1'] = 'CN/'
