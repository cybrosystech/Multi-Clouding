    ...
    def create_initial_bill(self):
        ...
        if self.leasor_type == 'single':
            ...
            for leasor in self.multi_leasor_ids:
                partner = leasor.partner_id
                leasor_direct_cost = (
                                             leasor.amount / self.installment_amount) * self.initial_direct_cost if leasor.type == 'amount' else leasor.percentage * amount / 100
                leasor_payment_value = (
                                               leasor.amount / self.installment_amount) * self.initial_payment_value if leasor.type == 'amount' else leasor.percentage * amount / 100
                incentives_received = (
